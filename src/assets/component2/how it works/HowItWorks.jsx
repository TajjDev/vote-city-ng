        ...
        <div style={{overflowY:isOpen ?"auto":""}} id="priv">
          ...
          {isOpenn && (
            <div className="popup">
              ...
              <p>a. You are expressly prohibited from collecting, downloading, copying, or otherwise
                ...
                (iv) to post, transmit, or cause to be posted or transmitted, any communication or
                solicitation designed to obtain passwords, accounts, or private information of other Users
                or persons; <br />
                (v) to post copyrighted content which does not belong to You and without obtaining the
                prior consent of the author; <br />
                (vi) to use a robot, spider, scraper, or other automated means to access this Service
                without obtaining the prior consent of the Owner; <br />
                (vii) to engage in or create any unlawful gambling, sweepstakes, or scheme; <br />
                ...
                (x) to engage in advertisement or solicit any User to buy or sell products or services <br />
                without obtaining the prior consent of the Owner; <br />
                ...
                (xiii) to use the Website or any of the Services for illegal spam activities. <br />
                c. Additionally, you agree that You will not do as follows: <br />
                ...
                (iv) to damage, disable, overburden or impair this Service or any other person's use of this
                Service. <br />
                (v) to use this Service contrary to the applicable laws and regulations or in a way that
              ...
              <p>a. You agree that we retain ownership of all Content included on the Website (text, graphics,
                ...
                b. You are granted a limited license only, subject to the restrictions provided in these Terms.
                ...
                c. You hereby agree not to reproduce or distribute the Owner's intellectual property or use the
              ...
              <p>You hereby agree as follows: <br />
                (I) not to reverse engineer or permit the reverse engineering or disassemble any code or
                software from or on the Website or Services; and <br />
                (II) not to violate the Security of the Website or other Services through any unauthorized
              ...
              <p>a. You accept that the Owner may vary, alter, amend, or update the Content or Service at any
                time and without Your consent. <br />
                b. You also agree that the Service may not be available at all times and this may be due to
              ...
              <p>a. Assignment: The Owner shall be permitted to assign and transfer its rights and/or obligations
                ...
                b. Entire Agreement: These Terms, disclaimers, and any other agreement relating to the use of
                this Website constitute the entire agreement and shall supersede any other agreement. <br />
                c. Separate Agreements: You may have other legal agreements with us. Those agreements are
                ...
                d. Applicable Law: These Terms may be governed and construed in accordance with the laws,
